...
public class Game implements Parcelable {
    ...
    /**
     * Describes any special contents of the object (Files, video, audio)
    ...
    public static final Parcelable.Creator<Game> CREATOR = new Creator<Game>() {
        ...
        /**
         * Allows creation of array of Game objects from JSON file.
         * Method repeatedly calls createFromParcel for every object.
         * @param size
         */
        @Override
